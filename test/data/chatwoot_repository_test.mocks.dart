...
// in chatwoot_client_sdk/test/data/chatwoot_repository_test.dart.
// Do not manually edit this file.

import 'dart:async' as _i11;

import 'package:async/src/stream_sink_transformer.dart' as _i19;
import 'package:chatwoot_client_sdk/chatwoot_callbacks.dart' as _i16;
...
import 'package:chatwoot_client_sdk/data/local/entity/chatwoot_message.dart'
    as _i7;
import 'package:chatwoot_client_sdk/data/local/local_storage.dart' as _i10;
...
import 'package:stream_channel/src/stream_channel_transformer.dart' as _i18;
...
class _FakeChatwootUserDao extends _i1.Fake implements _i2.ChatwootUserDao {}

class _FakeChatwootConversationDao extends _i1.Fake
    implements _i3.ChatwootConversationDao {}

class _FakeChatwootContactDao extends _i1.Fake
    implements _i4.ChatwootContactDao {}

class _FakeChatwootMessagesDao extends _i1.Fake
    implements _i5.ChatwootMessagesDao {}

class _FakeChatwootContact extends _i1.Fake implements _i6.ChatwootContact {}

class _FakeChatwootMessage extends _i1.Fake implements _i7.ChatwootMessage {}

class _FakeWebSocketSink extends _i1.Fake implements _i8.WebSocketSink {}

class _FakeStreamChannel<T> extends _i1.Fake implements _i9.StreamChannel<T> {}
...
class MockLocalStorage extends _i1.Mock implements _i10.LocalStorage {
  ...
  _i2.ChatwootUserDao get userDao =>
      (super.noSuchMethod(Invocation.getter(#userDao),
          returnValue: _FakeChatwootUserDao()) as _i2.ChatwootUserDao);
  @override
  ...
  _i3.ChatwootConversationDao get conversationDao =>
      (super.noSuchMethod(Invocation.getter(#conversationDao),
              returnValue: _FakeChatwootConversationDao())
  ...
  _i4.ChatwootContactDao get contactDao =>
      (super.noSuchMethod(Invocation.getter(#contactDao),
          returnValue: _FakeChatwootContactDao()) as _i4.ChatwootContactDao);
  @override
  set contactDao(_i4.ChatwootContactDao? _contactDao) =>
      super.noSuchMethod(Invocation.setter(#contactDao, _contactDao),
          returnValueForMissingStub: null);
  @override
  _i5.ChatwootMessagesDao get messagesDao =>
      (super.noSuchMethod(Invocation.getter(#messagesDao),
          returnValue: _FakeChatwootMessagesDao()) as _i5.ChatwootMessagesDao);
  @override
...
class MockChatwootClientService extends _i1.Mock
  ...
  _i11.Future<_i6.ChatwootContact> updateContact(dynamic update) =>
      (super.noSuchMethod(Invocation.method(#updateContact, [update]),
              returnValue:
                  Future<_i6.ChatwootContact>.value(_FakeChatwootContact()))
  ...
  _i11.Future<_i7.ChatwootMessage> createMessage(
      ...
      (super.noSuchMethod(Invocation.method(#createMessage, [request]),
              returnValue:
                  Future<_i7.ChatwootMessage>.value(_FakeChatwootMessage()))
...
class MockWebSocketChannel extends _i1.Mock implements _i8.WebSocketChannel {
  ...
  _i8.WebSocketSink get sink => (super.noSuchMethod(Invocation.getter(#sink),
      returnValue: _FakeWebSocketSink()) as _i8.WebSocketSink);
  @override
  ...
  _i9.StreamChannel<S> transform<S>(
          _i18.StreamChannelTransformer<S, dynamic>? transformer) =>
      (super.noSuchMethod(Invocation.method(#transform, [transformer]),
          returnValue: _FakeStreamChannel<S>()) as _i9.StreamChannel<S>);
  @override
  _i9.StreamChannel<dynamic> transformStream(
      ...
      (super.noSuchMethod(Invocation.method(#transformStream, [transformer]),
              returnValue: _FakeStreamChannel<dynamic>())
