...
import 'package:async/src/stream_sink_transformer.dart' as _i13;
...
import 'package:stream_channel/src/stream_channel_transformer.dart' as _i12;
...
class _FakeWebSocketSink extends _i1.Fake implements _i7.WebSocketSink {}

class _FakeStreamChannel<T> extends _i1.Fake implements _i8.StreamChannel<T> {}
...
class MockWebSocketChannel extends _i1.Mock implements _i7.WebSocketChannel {
  ...
  _i7.WebSocketSink get sink => (super.noSuchMethod(Invocation.getter(#sink),
      returnValue: _FakeWebSocketSink()) as _i7.WebSocketSink);
  @override
  ...
  _i8.StreamChannel<S> transform<S>(
          _i12.StreamChannelTransformer<S, dynamic>? transformer) =>
      (super.noSuchMethod(Invocation.method(#transform, [transformer]),
          returnValue: _FakeStreamChannel<S>()) as _i8.StreamChannel<S>);
  @override
